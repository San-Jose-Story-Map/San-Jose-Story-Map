  ...
  $(document).ready(function() {
    ...
    $.getJSON('data/features-3-29-2021.geojson', function(results) {
  ...
  map.on('load', function() {
    ...
    var img = document.getElementById("artist-img");
  ...
  function buildLocationList(data) {
    data.features.forEach(function(artist, i) {
      ...
      if (prop["photo submission"]) {
        ...
        details.innerHTML += "<br />" + "<img id ='artist-img' src='https://drive.google.com/uc?export=view&" + newLink +
  ...
  function createPopUp(currentFeature) {
    ...
    if (currentFeature.properties['bio url']) {
      popupContent += "<a id='artist-bio' href='" +
        currentFeature.properties['bio url'] + "'>" + "Artist Bio " + "</a>";
    }

    if (currentFeature.properties['personal url']) {
      popupContent += "<a id='artist-portfolio' href='" +
        currentFeature.properties['personal url'] + "'>" + "Portfolio" + "</a>";
    }
